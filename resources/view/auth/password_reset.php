...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-password-reset by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 04:39:43 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4">
                                <div class="col-12 text-center mb-1 mb-lg-5">
                                    <img src="../../../public/assets/images/forgot-password.svg" class="w240 mb-4" alt="" />
                                ...
                                <div class="col-12 text-center mt-4">
                                    <a href="2FA" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">SUBMIT</a>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted"><a href="login" class="text-secondary">Back to Sign in</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-password-reset by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 04:39:44 GMT -->
</html>