...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-signin by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 04:39:38 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-1 p-3 p-md-4" method="POST" action="/login/submit">
                                    ...
                                    <div class="mb-2">
                                        <div class="form-label">
                                            <span class="d-flex justify-content-between align-items-center">
                                                Password
                                                <a class="text-secondary" href="password_reset">Forgot Password?</a>
                                            </span>
                                        </div>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" name="sign_in" class="btn btn-lg btn-block btn-light lift text-uppercase" atl="signin">SIGN IN</button>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted">Don't have an account yet? <a href="register" class="text-secondary">Sign up here</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-signin by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 04:39:39 GMT -->
</html>